...
export const encryption = (params) => {
  ...
  if (type === "Base64") {
    ...
    param.forEach(ele => {
      result[ele] = window.CryptoJS.MD5(result[ele]).toString();
    });
  }
  return result;
};
...
export const diff = (obj1, obj2) => {
  ...
  if (obj1.value.lastIndexOf("?") !== -1) {
    value1 = obj1.value.substring(0, obj1.value.lastIndexOf("?"));
  }
  let value2 = obj2.value;
  if (obj2.value.lastIndexOf("?") !== -1) {
    value2 = obj2.value.substring(0, obj2.value.lastIndexOf("?"));
  }
  if (value1 === value2) {
    return true;
  }
